package com.logansoft.UIEngine.view.AotoViewPager;
...
public class AutoScrollViewPager extends ViewPager {
    ...
    public  boolean                SCROLL_ALLOW                =true;
...
//    }
    ...
    public boolean isSCROLL_ALLOW() {
		return SCROLL_ALLOW;
	}

	public void setSCROLL_ALLOW(boolean sCROLL_ALLOW) {
