package com.logansoft.UIEngine.utils.ninePatch;
...
public class NinePatchChunk implements Externalizable {
	...
	public static ImageLoadingResult createChunkFromRawBitmap(Context context,
			InputStream inputStream, int ImageH, int ImageW) {
		BitmapFactory.Options opts = new BitmapFactory.Options();
