 ...
 *******************************************************************************/
package com.logansoft.UIEngine.view.pullToRefresh;

import com.logansoft.UIEngine.R;
import com.logansoft.UIEngine.view.pullToRefresh.internal.FlipLoadingLayout;
import com.logansoft.UIEngine.view.pullToRefresh.internal.LoadingLayout;
import com.logansoft.UIEngine.view.pullToRefresh.internal.RotateLoadingLayout;
import com.logansoft.UIEngine.view.pullToRefresh.internal.Utils;
import com.logansoft.UIEngine.view.pullToRefresh.internal.ViewCompat;
...
public abstract class PullToRefreshBase<T extends View> extends LinearLayout implements IPullToRefresh<T> {
	...
	private void addRefreshableView(Context context, T refreshableView) {
		...
		mRefreshableViewWrapper.addView(refreshableView, ViewGroup.LayoutParams.MATCH_PARENT,height);
		addViewInternal(mRefreshableViewWrapper, new LinearLayout.LayoutParams(LayoutParams.MATCH_PARENT,height));
	}
	@Override 
	public void setLayoutParams(ViewGroup.LayoutParams params){
		super.setLayoutParams(params);
		if(mRefreshableViewWrapper!=null && mRefreshableViewWrapper.getLayoutParams()!=null){
			int height=ViewGroup.LayoutParams.MATCH_PARENT;
			if(params!=null && params.height==ViewGroup.LayoutParams.WRAP_CONTENT)
				height=ViewGroup.LayoutParams.WRAP_CONTENT;
			ViewGroup.LayoutParams wrapperLayoutParams=mRefreshableViewWrapper.getLayoutParams();
			wrapperLayoutParams.height=height;
			mRefreshableViewWrapper.setLayoutParams(wrapperLayoutParams);
			View refreshableView=this.getRefreshableView();
			ViewGroup.LayoutParams refreshableViewLayoutParams=refreshableView.getLayoutParams();
			refreshableViewLayoutParams.height=height;
			refreshableView.setLayoutParams(refreshableViewLayoutParams);
		}
	}
